...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        // (OPTIONAL) Verify we got a row back
        ...
        // (OPTIONAL) Move the cursor to a valid database row and check to see if we got any query back
        assertTrue("Error, no records returned from cocation query", cursor.moveToFirst());
        ...
        //(OPTIONAL) move the cursor to demonstrate that there's only one record in the database
